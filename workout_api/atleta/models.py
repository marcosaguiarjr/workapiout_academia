...
from sqlalchemy import DateTime, ForeignKey, Integer, String, Float, UUID
from sqlalchemy.orm import Mapped, mapped_column, relationship
from workout_api.contrib.models import BaseModel
# Importe também o modelo de CT para evitar erros de referência circular
...
class AtletaModel(BaseModel):
    ...
    # Adicione o ID UUID se ele não existir no seu BaseModel
    ...
    # Ajuste: back_populates deve bater com o nome da lista no outro modelo
